...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 健康报告卡
    /// </summary>
    public class HealthAbstractCommand : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object context,EventArgs e)
        {
            ...
            {
                GlobalVariable.ReportCardCenterObj.Modify(Core.Enum.ReportCardEnum.HealthAbstractReport, pat);
            }
        ...
        public string ID
        {
            get { return MenuCommandId.HealthAbstractCommandID; }
        }
    }
}
