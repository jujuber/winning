...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 高血压报告卡
    /// </summary>
    public class HypertensionCommand : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object context,EventArgs e)
        {
            ...
            {
                GlobalVariable.ReportCardCenterObj.Modify(Core.Enum.ReportCardEnum.HypertensionReport, pat);
            }
        ...
        public string ID
        {
            get { return MenuCommandId.HypertensionCommandID; }
        }
    }
}
