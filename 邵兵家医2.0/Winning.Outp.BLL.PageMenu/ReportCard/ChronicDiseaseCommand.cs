...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 慢性病报告卡
    /// </summary>
    public class ChronicDiseaseCommand : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object context,EventArgs e)
        {
            ...
            {
                GlobalVariable.ReportCardCenterObj.Modify(Core.Enum.ReportCardEnum.ChronicDiseaseReport, pat);
            }
        ...
        public string ID
        {
            get { return MenuCommandId.ChronicDiseaseCommandID; }
        }
    }
}
