...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 伤害报告卡
    /// </summary>
    public class HurtCommand : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object context,EventArgs e)
        {
            ...
            {
                GlobalVariable.ReportCardCenterObj.Modify(Core.Enum.ReportCardEnum.HurtReport, pat);
            }
        ...
        public string ID
        {
            get { return MenuCommandId.HurtCommandID; }
        }
    }
}
