...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 传染病报告卡
    /// </summary>
    public class InfectiousDiseaseCommand : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object context,EventArgs e)
        {
            ...
            {
                GlobalVariable.ReportCardCenterObj.Modify(Core.Enum.ReportCardEnum.InfectiousDiseaseReport, pat);
            }
        ...
        public string ID
        {
            get { return MenuCommandId.InfectiousDiseaseCommandID; }
        }
    }
}
