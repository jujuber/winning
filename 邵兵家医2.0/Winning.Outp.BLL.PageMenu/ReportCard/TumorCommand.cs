...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 肿瘤报告卡
    /// </summary>
    public class TumorCommand : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object context, EventArgs e)
        {
            ...
            {
                GlobalVariable.ReportCardCenterObj.Modify(Core.Enum.ReportCardEnum.TumorReport, pat);
            }
        ...
        public string ID
        {
            get { return MenuCommandId.TumorCommandID; }
        }
    }
}
