...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 结核病报告卡
    /// </summary>
    public class TuberculosisCommand : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object context,EventArgs e)
        {
            ...
            {
                GlobalVariable.ReportCardCenterObj.Modify(Core.Enum.ReportCardEnum.TuberculosisReport, pat);
            }
        ...
        public string ID
        {
            get { return MenuCommandId.TuberculosisCommandID; }
        }
    }
}
