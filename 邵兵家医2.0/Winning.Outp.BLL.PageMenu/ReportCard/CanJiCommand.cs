...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 残联报告卡
    /// </summary>
    public class CanJiCommand : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object context,EventArgs e)
        {
            ...
            {
                GlobalVariable.ReportCardCenterObj.Modify(Core.Enum.ReportCardEnum.CanJiReport, pat);
            }
        ...
        public string ID
        {
            get { return MenuCommandId.CanJiCommandID; }
        }
    }
}
