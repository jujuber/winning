...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 食源报告卡
    /// </summary>
    public class FoodOriginCommand : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object context,EventArgs e)
        {
            ...
            {
                GlobalVariable.ReportCardCenterObj.Modify(Core.Enum.ReportCardEnum.FoodOriginReport, pat);
            }
        ...
        public string ID
        {
            get { return MenuCommandId.FoodOriginCommandID; }
        }
    }
}
