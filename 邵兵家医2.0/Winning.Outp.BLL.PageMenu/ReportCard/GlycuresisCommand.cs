...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 糖尿病报告卡
    /// </summary>
    public class GlycuresisCommandID : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object context,EventArgs e)
        {
            ...
            {
                GlobalVariable.ReportCardCenterObj.Modify(Core.Enum.ReportCardEnum.GlycuresisReport, pat);
            }
        ...
        public string ID
        {
            get { return MenuCommandId.GlycuresisCommandID; }
        }
    }
}
