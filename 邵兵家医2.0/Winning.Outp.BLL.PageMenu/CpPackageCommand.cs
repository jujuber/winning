...
{
    public class CpPackageCommand : ICommand
    {
        public string ID
        {
            get { return MenuCommandId.CpPackageCommandID; }
        }
        ...
        public FrameWork.Core.Common.RequestResult Execute(object sender, EventArgs e)
        {
            ...
            {
                object ErrMsg = null;
                ret = GlobalVariable.HisSys.Reflected.RunNetApp("Winning.Outp.UI.JTYS.CpPackage.dll", "Winning.Outp.UI.JTYS.CpPackage.StartUp", "Run", out ErrMsg, pat);
            }
