...
{
    public class DrugOrderUpCommand : ICommand
    {
        public string ID
        {
            get { return MenuCommandId.DrugOrderUpCommandID; }
        }
        ...
        public FrameWork.Core.Common.RequestResult Execute(object sender, EventArgs e)
        {
            ...
            {
                object ErrMsg = null;
                ret = GlobalVariable.HisSys.Reflected.RunNetApp("Winning.Outp.UI.JTYS.DrugOrderUpload.dll", "Winning.Outp.UI.JTYS.DrugOrderUpload.StartUp", "Run", out ErrMsg, pat);
            }
