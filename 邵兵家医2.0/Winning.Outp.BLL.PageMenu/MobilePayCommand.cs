...
{
    public class MobilePayCommand : ICommand
    {
        public string ID
        {
            get { return MenuCommandId.MobilePayCommandID; }
        }
        ...
        public FrameWork.Core.Common.RequestResult Execute(object sender, EventArgs e)
        {
            ...
            {
                object ErrMsg = null;
                ret = GlobalVariable.HisSys.Reflected.RunNetApp("Winning.Outp.UI.JTYS.MobilePayment.dll", "Winning.Outp.UI.JTYS.MobilePayment.StartUp", "Run", out ErrMsg, pat);
            }
