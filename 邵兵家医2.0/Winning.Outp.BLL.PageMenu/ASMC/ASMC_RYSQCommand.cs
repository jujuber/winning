...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    ///  入院申请（日间）
    /// </summary>
    public class ASMC_RYSQCommand : ICommand
    {
        public FrameWork.Core.Common.RequestResult Execute(object sender, EventArgs e)
        {
            try
            {
                ...
                if (File.Exists(batPath))
                {
                    ...
                    GlobalVariable.HisSys.Reflected.RunNetApp("Winning.Mzys.Asmc.External.dll", "Winning.Mzys.Asmc.External.StartUpRySq", "Run", out msg, "入院申请", "");
        ...
        public string ID
        {
            get { return MenuCommandId.ASMC_RYSQ_CommandID; }
        }
    }
}
