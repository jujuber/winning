...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 健康档案
    /// </summary>
    public class HealthRecordsCommand : ICommand
    {     
        public string ID
        {
            get { return MenuCommandId.HealthRecordsCommandID; }
        }
        public FrameWork.Core.Common.RequestResult Execute(object sender, EventArgs e)
        {
            ...
            {
                object ErrMsg = null;
                ret = GlobalVariable.HisSys.Reflected.RunNetApp("Winning.Outp.UI.JTYS.PrescribeExtend.dll", "Winning.Outp.UI.JTYS.PrescribeExtend.StartUp", "Run", out ErrMsg, pat);
            }
