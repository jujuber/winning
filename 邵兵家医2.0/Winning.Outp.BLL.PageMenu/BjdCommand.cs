...
namespace Winning.Outp.BLL.PageMenu
{
    ...
    /// 病假单
    /// </summary>
    public class BjdCommand : ICommand
    {
      

        public string ID
        {
            get { return MenuCommandId.BJDCommandID; }
        }
        ...
        public FrameWork.Core.Common.RequestResult Execute(object sender, EventArgs e)
        {
            ...
            {
                object ErrMsg = null;
                ret = GlobalVariable.HisSys.Reflected.RunNetApp("Winning.Outp.UI.Bjd.dll", "Winning.Outp.UI.Bjd.StartUp", "Run", out ErrMsg,pat);
            }
